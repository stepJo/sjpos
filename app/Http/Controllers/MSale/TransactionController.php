...
class TransactionController extends Controller
{
    ...
    {
        return Excel::download(new TransactionsExport, 'Data_Transaksi_'.date('d_F_Y').'.csv');
    }

    public function exportExcel()
    {
        return Excel::download(new TransactionsExport, 'Data_Transaksi_'.date('d_F_Y').'.xlsx');
    }
